...
**spark-vllm-docker pinned (Mar 19):** Commit 57b4585 on spark-2. Update 919a881 (Ray port 6379→29501, sed/exec changes) caused repeated hard crashes during CUDA graph capture. Reverted. Do NOT run `git pull` on spark-2 repo until upstream fix confirmed.
